...
public class GoodsListActivity extends BaseActivity {
    ...
    @BindView(R.id.goodslist_orderby_price_img)
    ImageView goodslistOrderbyPriceImg;
    ...
    @BindView(R.id.goodslist_orderby)
    LinearLayout goodslistOrderby;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.catId=intent.getIntExtra("cat_id",0);//从商品分类界面传递过来的参数
        Log.i("--------","catId---"+this.catId);
        this.keyword=intent.getStringExtra("keyword");//商品搜索界面传递过来的参数
        initViews();
    }
    ...
    @OnClick({R.id.title_back, R.id.search_keyword, R.id.goodslist_orderby_sales, R.id.goodslist_orderby_grade, R.id.goodslist_orderby_price, R.id.goodslist_orderby_newgoods, R.id.goodslist_recyclerview, R.id.goodslist_nodata})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.goodslist_orderby_newgoods:
                break;
            case R.id.goodslist_recyclerview:
                break;
            case R.id.goodslist_nodata:
                break;
        }
    }
    /**
